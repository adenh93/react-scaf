...
exports.outputFiles = exports.rollbackChanges = exports.addComponentDirectory = void 0;
var fs = require("fs");
var chalk = require("chalk");
var config_1 = require("./config");
var addComponentDirectory = function (directoryName, dirsAdded) {
    fs.mkdirSync(directoryName);
    dirsAdded.push(directoryName);
};
exports.addComponentDirectory = addComponentDirectory;
var rollbackChanges = function (dirsAdded) {
...
var generate = function (args) { return __awaiter(void 0, void 0, void 0, function () {
    var config, componentsDir, files, componentNames, dirsAdded;
                ...
                componentNames.forEach(function (componentName) {
                    try {
                        ...
                        if (!fs.existsSync(outputDir)) {
                            (0, exports.addComponentDirectory)(outputDir, dirsAdded);
                            (0, exports.outputFiles)(files, componentName, outputDir);
                        }
                        else {
                        ...
                        (0, exports.rollbackChanges)(dirsAdded);
                        throw err;
                    }
                });
                return [2 /*return*/];
